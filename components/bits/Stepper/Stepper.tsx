...
function StepIndicator({
  ...
  return (
    ...
    >
      <motion.div
        variants={{
          inactive: { scale: 1, backgroundColor: "#1a1a2e", color: "#5c5c8a" },
          active: { scale: 1, backgroundColor: "#00d8ff", color: "#3b82f6" },
          complete: { scale: 1, backgroundColor: "#ff007f", color: "#00d8ff" },
        }}
