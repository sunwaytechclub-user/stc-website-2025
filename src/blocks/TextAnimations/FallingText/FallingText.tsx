...
interface FallingTextProps {
    ...
    fontSize?: string;
    onTriggerRef?: React.MutableRefObject<{ trigger: () => void } | null>;
}
...
const FallingText: React.FC<FallingTextProps> = ({
    ...
    useEffect(() => {
        ...
        const newHTML = words
            .map((word) => {
                const highlight = highlightWords.find((hw) => word.startsWith(hw.word));
                return highlight
                    ? `<span class="word" style="color: ${highlight.color}">${word}</span>`
